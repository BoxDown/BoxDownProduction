    ...
    private void UpdateCardInfo(bool swappingModule)
    {
        ...
        switch (C_gunModuleReference.e_moduleType)
        {
            case GunModule.ModuleSection.Trigger:
                ...
                C_statValueBar1.transform.localScale = new Vector3(ExtraMaths.Map(6f, 24f, 0.2f, 1.0f, C_gunModuleReference.f_baseDamage + C_gunModuleReference.S_bulletTraitInformation.f_explosionDamage), 1, 1);
                C_statValueBar1.color = C_statBarGradient.Evaluate(C_statValueBar1.transform.localScale.x);
                C_statValueBar2.transform.localScale = new Vector3(ExtraMaths.Map(3.5f, 13f, 0.2f, 1.0f, C_gunModuleReference.f_fireRate), 1, 1);
            ...
            case GunModule.ModuleSection.Clip:
                ...
                //Values scale on x axis for horizontal fill, magic numbers at the start of maps are minimum and maximum
                C_statValueBar1.transform.localScale = new Vector3(ExtraMaths.Map(8, 60, 0.2f, 1.0f, C_gunModuleReference.i_clipSize), 1, 1);
                C_statValueBar1.color = C_statBarGradient.Evaluate(C_statValueBar1.transform.localScale.x);
                C_statValueBar2.transform.localScale = new Vector3(ExtraMaths.Map(1 / 3f, 1 / 0.3f, 0.2f, 1.0f, 1 / C_gunModuleReference.f_reloadSpeed), 1, 1);
                C_statValueBar2.color = C_statBarGradient.Evaluate(C_statValueBar2.transform.localScale.x);
            ...
            case GunModule.ModuleSection.Barrel:
                ...
                //Values scale on x axis for horizontal fill, magic numbers at the start of maps are minimum and maximum
                C_statValueBar1.transform.localScale = new Vector3(ExtraMaths.Map(0.25f, 0.7f, 0.2f, 1.0f, C_gunModuleReference.f_bulletSize), 1, 1);
                C_statValueBar1.color = C_statBarGradient.Evaluate(C_statValueBar1.transform.localScale.x);
                C_statValueBar2.transform.localScale = new Vector3(ExtraMaths.Map(5, 8f, 0.2f, 1.0f, C_gunModuleReference.f_bulletRange), 1, 1);
                C_statValueBar2.color = C_statBarGradient.Evaluate(C_statValueBar2.transform.localScale.x);
