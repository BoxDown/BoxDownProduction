    ...
    private void UpdateCardInfo(bool swappingModule)
    {
        ...
        switch (C_gunModuleReference.e_moduleType)
        {
            case GunModule.ModuleSection.Trigger:
                ...
                C_statValueBar1.transform.localScale = new Vector3(ExtraMaths.Map(6f, 24f, 0.1f, 0.9f, C_gunModuleReference.f_baseDamage + C_gunModuleReference.S_bulletTraitInformation.f_explosionDamage), 1, 1);
